...
def fix_talent_tree_links(content_path):
    ...
    try:
        ...
        if converted_content != original_content:
            ...
            backup_path = talent_trees_path.with_suffix(talent_trees_path.suffix + '.backup')
            ...
            if original_links:
                ...
                for i, (href, text) in enumerate(original_links[:3]):  # Show first 3
                    ...
                    new_href = f"/verdigris/Characters/Talents/{file_slug}#{anchor_slug}" if anchor_slug else f"/verdigris/Characters/Talents/{file_slug}"
...
def main():
    ...
    # Define paths
    obsidian_vault_path = Path(r"C:\Users\donutrj\Documents\obsidian\Verdigris")
