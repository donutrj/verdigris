...
| 5    | Hit Points                         |
| 6    | Roll again & increase by 2 instead |
*Rolling sixes multiple times does not mean the result stacks, Archer.*
# Background
...
# Skills
Skills are bonuses that represent your character's learned knowledge. Characters start with one point in any three skills. Learn more about them [[Stats#Skills|here]].
# Dynamic
When making a character, work with the other players in the party to come up with at least one shared event between each other. You do not need to be friends with the other characters to start, but should have at least passing familiarity with at least one other character.
# Gear
